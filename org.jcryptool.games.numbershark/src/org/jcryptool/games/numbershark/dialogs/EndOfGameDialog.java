...
public class EndOfGameDialog {
	...
	private int[] optValues = { 0, 2, 3, 7, 9, 15, 17, 21, 30, 40, 44, 50, 52, 66, 81, 89, 93, 111, 113, 124, 144, 166,
			...
			36118, 36239, 36449, 36587, 36827, 37170, 37350, 37695, 38041, 38051, 38261, 38263, 38463, 38715, 38955,
			38959, 39313, 39467, 39823, 40167, 40525, 40531, 40731, 40803, 41165, 41528, 41769, 41921, 42287, 42295,
			42625, 42994, 43364, 43500, 43698, 43704, 44078, 44328, 44532, 44656, 45034, 45040, 45266, 45421, 45803,
			45807, 45999, 46384, 46770, 47157, 47545, 47551, 47770, 47914, 48306, 48445, 48839, 49015, 49409, 49417,
			49815, 50197, 50437, 50441, 50843, 50927, 51331, 51729, 52135, 52325, 52693, 52701, 53111, 53260, 53672,
			53820, 54120, 54298, 54554, 54697, 55115, 55125, 55509, 55511, 55933, 56356, 56592, 57010, 57436, 57568,
			57996, 58402, 58832, 58842, 59259, 59261, 59695, 60130, 60566, 60680, 61118, 61124, 61540, 61886, 62328,
			62332, 62590, 62786, 63232, 63401, 63837, 63843, 64214, 64406, 64858, 65013, 65467, 65757, 66025, 66033,
			66491, 66922, 67344, 67348, 67760, 67762, 68122, 68587, 69053, 69057, 69350, 69514, 69984, 70153, 70413,
			70599, 71073, 71440, 71889, 72366, 72844, 72856, 73120, 73260, 73742, 74098, 74558, 74776, 75247, 75255,
			75507, 75682, 76172, 76176, 76446, 76640, 77134, 77533, 77925, 78087, 78585, 78593, 78934, 79109, 79611,
			79615, 80119, 80333, 80839, 81110, 81618, 81624, 82085, 82241, 82497, 82938, 83452, 83664, 83934, 84150,
			84668, 84853 };
		...
		if (playerScore > sharkScore) {
			if (view.getNumberOfFields() - 1 <= optValues.length) {
				if (playerScore == optValues[gameNMax - 1]) {
					...
					msg = NLS.bind(Messages.EndOfGameDialog_1,
							new Object[] { playerScore, sharkScore, gameNMax, optValues[gameNMax - 1] });
				}
			} else {
